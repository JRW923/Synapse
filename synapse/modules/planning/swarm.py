...
class SwarmPlanner:
    ...
    def _make_planner(self, spec: RoleSpec, file_scope: str = "", worktree_path: str = ""):
        ...
        return ReActPlanner(
            ...
            history_compaction=getattr(base, "history_compaction", "elide"),
            history_soft_chars=getattr(base, "history_soft_chars", 120_000),
            history_keep_recent_tools=getattr(base, "history_keep_recent_tools", 6),
            history_keep_recent_turns=getattr(base, "history_keep_recent_turns", 4),
            compact_rotate_after=getattr(base, "compact_rotate_after", 3),
            auth=auth,
